const SNOWFLAKES_COUNT = 200; // Snowflake count, can be overwritten by attrs
let baseCSS = ``;
...
function generateSnowCSS(snowDensity = 200) {
    ...
    // Calcula a altura máxima onde os flocos de neve podem cair (altura da janela - 100px)
    ...
    for (let i = 1; i <= snowDensity; i++) {
        ...
        let fallDuration = randomIntRange(10, 30); // s
