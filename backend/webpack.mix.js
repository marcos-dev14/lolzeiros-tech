...
mix.js('resources/js/app.js', 'public/js')
    ...
    .sass('resources/scss/pages/opportunities.scss', 'public/css')
    .sass('resources/scss/pages/opportunities-details.scss', 'public/css')
    .sass('resources/scss/pages/clients-seller.scss', 'public/css')
    .sass('resources/scss/pages/available-customers.scss', 'public/css')
