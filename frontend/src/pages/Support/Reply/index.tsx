...
import { LocationState } from '~types/main';

import { ReactComponent as GoBackIcon } from '~assets/goback_arrow.svg';

import { Container, Button, ReplyContainer, ReplyContainerInfo, AvatarContainer, Options, AttachmentContainer, GoBackButton } from './styles';
