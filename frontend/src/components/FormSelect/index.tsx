...
//   const { customWidth, newOption } = selectProps;
  
//   return (
//       <components.MenuList {...rest}>
//         {!!newOption && 
//           <Menu style={{ width: customWidth }} onClick={() => {}}>
//             {newOption}
//           </Menu>
//         }
//       {children}
...
interface FormSelectProps {
  ...
  badge?: boolean;
  placeholder?: string;
  customValue?: DefaultValueProps;
  customDefaultValue?: DefaultValueProps;
...
export function FormSelect({
  ...
  const defaultValue = useMemo(() => {
    const customDefaultValueIsNotEmpty =
      !!Object.entries(customDefaultValue).length;

    return customDefaultValueIsNotEmpty ? 
      customDefaultValue :
      { value: formDefaultValue, label: formDefaultValue }
    ;
      ...
      styles={{
        ...
        option: (styles, { isDisabled, isFocused, isSelected, label }) => {
          ...
          return {
            ...
            backgroundColor:
              badge ? badgeColors[label === "Liberado" ? 'Recebido' : label] :
                isDisabled ? null :
                isSelected ? "#8FE7D0" :
                isFocused ? "#f4f5f8" :
                null,
